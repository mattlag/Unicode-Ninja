var unicodeBlocks = {
    ...
    'r-0860-086F': {begin: 0x0860, end: 0x086F, name: 'Syriac Supplement'},
    ...
    'r-1700-171F': {begin: 0x1700, end: 0x171F, name: 'Tagalog'},
    'r-1720-173F': {begin: 0x1720, end: 0x173F, name: 'Hanunoo'},
    'r-1740-175F': {begin: 0x1740, end: 0x175F, name: 'Buhid'},
    'r-1760-177F': {begin: 0x1760, end: 0x177F, name: 'Tagbanwa'},
    ...
    'r-1A20-1AAF': {begin: 0x1A20, end: 0x1AAF, name: 'Tai Tham'},
    'r-1AB0-1AFF': {begin: 0x1AB0, end: 0x1AFF, name: 'Combining Diacritical Marks Extended'},
    ...
    'r-1C80-1C8F': {begin: 0x1C80, end: 0x1C8F, name: 'Cyrillic Extended-C'},
    ...
    'r-A800-A82F': {begin: 0xA800, end: 0xA82F, name: 'Syloti Nagri'},
    ...
    'r-A930-A95F': {begin: 0xA930, end: 0xA95F, name: 'Rejang'},
    ...
    'r-AA80-AADF': {begin: 0xAA80, end: 0xAADF, name: 'Tai Viet'},
    'r-AAE0-AAFF': {begin: 0xAAE0, end: 0xAAFF, name: 'Meetei Mayek Extensions'},
    ...
    'r-D800-DB7F': {begin: 0xD800, end: 0xDB7F, name: 'High Surrogates'},
    'r-DB80-DBFF': {begin: 0xDB80, end: 0xDBFF, name: 'High Private Use Surrogates'},
    'r-DC00-DFFF': {begin: 0xDC00, end: 0xDFFF, name: 'Low Surrogates'},
    'r-E000-F8FF': {begin: 0xE000, end: 0xF8FF, name: 'Private Use Area'},
    ...
    'r-FE00-FE0F': {begin: 0xFE00, end: 0xFE0F, name: 'Variation Selectors'},
    ...
    'r-FFF0-FFFF': {begin: 0xFFF0, end: 0xFFFF, name: 'Specials'},
};