	...
	function makeOneSquare(txt){
		var re = "<div class='symbol' title='"+getUnicodeName(txt)+"' onclick='clickSymbol(\""+txt+"\");'>&"+txt+";</div>";
		return re;
	}

	function clickSymbol(sym){
		var re = "<input class='showclickleft' value='&"+sym+";'>"+
			"<input class='showclickright' type='text' value='&amp;"+sym+";'>"+
			"<br><input class='showbottomclick' type='text' value='"+getUnicodeName(sym).replace('<','').replace('>','')+"'>";
